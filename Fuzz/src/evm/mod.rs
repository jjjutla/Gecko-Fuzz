...
pub struct EvmArgs {
    ...
    /// Target type (glob, address) (Default: AutoXRPally infer from target)
    #[arg(long)]
    ...
    /// Detectors enabled (all, high_confidence, ...). Refer to https://docs.gecko.rs/docs-evm-contract/detecting-common-vulns
