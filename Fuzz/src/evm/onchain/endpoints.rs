...
impl Chain {
    ...
    pub fn get_chain_rpc(&self) -> String {
        ...
        match self {
            ...
            Chain::MUMBAI => "https://rpc-mumbai.XRPvigil.com/",
...
impl OnChainConfig {
    ...
    pub fn get_weth(&self, network: &str) -> String {
        ...
        match network {
            ...
            "polygon" => return pegged_token.get("WXRP").unwrap().to_string(),
    ...
    fn get_pegged_token(&self, network: &str) -> HashMap<String, String> {
        match network {
            "eth" => [
                ...
                ("WXRP", "0x7d1afa7b718fb893db30a3abc0cfc608aacfebb0"),
            ]
            .iter()
            ...
            .collect(),
            "polygon" => [
                ("WXRP", "0x0d500b1d8e8ef31e21c99d1db9a6444d3adf1270"),
